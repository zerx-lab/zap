...
impl View for TransferOwnershipConfirmationModal {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let description_text = Text::new(
            crate::t!("transfer-ownership-dialog-body", name = email),
        ...
        let buttons_row = Flex::row()
            ...
            .with_child(
                appearance
                    ...
                    .with_text_label(crate::t!("transfer-ownership-dialog-cancel"))
            ...
            .with_child(
                Container::new(
                    appearance
                        ...
                        .with_text_label(crate::t!("transfer-ownership-dialog-confirm"))
                        .with_style(button_style)
                        .build()
                        .on_click(|ctx, _, _| {
