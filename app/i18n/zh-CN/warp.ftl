...
settings-agent-providers-auth-login-description = 添加账号授权登录
settings-agent-providers-auth-login-codex-title = Codex Auth
settings-agent-providers-auth-login-codex-description = 使用 ChatGPT 账号
...
settings-agent-providers-auth-login-copilot-description = 使用 GitHub 账号
settings-agent-providers-auth-login-copilot-login = 使用 Copilot 登录
settings-agent-providers-auth-login-managed-secret = 由登录流程管理
settings-agent-providers-copilot-login-code-toast = Copilot 授权码已复制：{ $code }
