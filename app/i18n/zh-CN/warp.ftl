...
settings-appearance-markdown-heading-h4-label = H4 系数
settings-appearance-markdown-heading-h5-label = H5 系数
settings-appearance-markdown-heading-h6-label = H6 系数
