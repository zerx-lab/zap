...
workspace-left-panel-ssh-manager-su-password-prompt = 检测到 su 密码提示，是否自动输入 Root 密码？
workspace-left-panel-ssh-manager-su-password-auto-fill = 自动输入
workspace-left-panel-ssh-manager-su-password-cancel = 取消
