...
markdown-heading-scale-reset-confirm-title = 恢复默认值
markdown-heading-scale-reset-confirm-body = 是否将所有 Markdown 标题字号倍率恢复为默认值？
markdown-heading-scale-reset-confirm-ok = 恢复
