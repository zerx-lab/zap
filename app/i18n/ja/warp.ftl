...
settings-agent-providers-auth-login-description = アカウント認証ログインを追加します
settings-agent-providers-auth-login-codex-title = Codex Auth
settings-agent-providers-auth-login-codex-description = ChatGPT アカウントを使用します
...
settings-agent-providers-auth-login-copilot-description = GitHub アカウントを使用します
settings-agent-providers-auth-login-copilot-login = Copilot でログイン
settings-agent-providers-auth-login-managed-secret = 認証ログインによって管理されています
settings-agent-providers-copilot-login-code-toast = Copilot 認証コードをコピーしました: { $code }
