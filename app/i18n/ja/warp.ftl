...
settings-agent-providers-auth-login-description = Codex でログインして、新しい Codex Auth プロバイダーを追加します。トークンはプロバイダーごとにシステムキーチェーンへ保存されます。
...
settings-agent-providers-auth-login-login = Codex でログイン
settings-agent-providers-auth-login-managed-secret = Codex Auth によって管理されています。トークンはシステムキーチェーンに保存されます。
