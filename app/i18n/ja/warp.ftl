...
markdown-heading-scale-reset-confirm-title = デフォルトに戻す
markdown-heading-scale-reset-confirm-body = すべてのMarkdown見出しスケールをデフォルト値にリセットしますか？
markdown-heading-scale-reset-confirm-ok = リセット
