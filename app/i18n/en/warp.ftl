...
markdown-heading-scale-reset-confirm-title = Reset to Default
markdown-heading-scale-reset-confirm-body = Reset all markdown heading scales to default values?
markdown-heading-scale-reset-confirm-ok = Reset
