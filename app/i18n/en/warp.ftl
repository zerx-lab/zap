...
workspace-empty-title = No tabs in this workspace
workspace-empty-subtitle = Open a terminal to start working in this worktree.
workspace-empty-new-terminal = New terminal
