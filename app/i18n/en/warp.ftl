...
workspace-left-panel-ssh-manager-su-password-prompt = su password prompt detected. Auto-fill root password?
workspace-left-panel-ssh-manager-su-password-auto-fill = Auto Fill
workspace-left-panel-ssh-manager-su-password-cancel = Cancel
