...
settings-agent-providers-auth-login-description = Add account authorization login
settings-agent-providers-auth-login-codex-title = Codex Auth
settings-agent-providers-auth-login-codex-description = Use your ChatGPT account
...
settings-agent-providers-auth-login-copilot-description = Use your GitHub account
settings-agent-providers-auth-login-copilot-login = Log in with Copilot
settings-agent-providers-auth-login-managed-secret = Managed by auth login
settings-agent-providers-copilot-login-code-toast = Copilot code copied: { $code }
